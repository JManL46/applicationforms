<?php
/**
 * @brief		Front Navigation Extension: form
...
class _Form extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	...
	{
		return \IPS\Member::loggedIn()->language()->addToStack('navbar_open_positions');
	}
	...
	{
		return \IPS\Http\Url::internal( "app=applicationform&module=applications&controller=form", 'front', 'application_formoverview' );
	}
