...
namespace IPS\applicationform\extensions\core\ModeratorPermissions;
...
class _ManageApplications
{
	...
	public function getPermissions()
	{
		$return = array();
			...
			$return['can_see_applicationdata'] = array( 'YesNo', array( 'togglesOn' => array( 'can_app_delete_submissions' ) ) );
			$return['can_fapp_delete_submissions'] = "YesNo";
