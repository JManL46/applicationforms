...
class _Submission
{
    static $dbTable = 'applicationform_applications';
    static $dbColumn = 'ip_address';
    static $dateColumn = 'date';
	...
	{
		return \IPS\Db::i()->select( static::$dbColumn . " AS ip, COUNT(*) AS count, MIN(" . static::$dateColumn . ") AS first, MAX(" . static::$dateColumn . ") AS last", static::$dbTable, array( 'member_id=?', $member->member_id ), NULL, NULL, static::$dbColumn )->setKeyField( 'ip' );
	}
}